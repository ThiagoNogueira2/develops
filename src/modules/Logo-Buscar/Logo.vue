    ...
    <div class="container pb-5 flex justify-between items-center flex-col gap-4 md:flex-row md:gap-0
      ...
      <div class="flex items-center gap-4 md:gap-6 w-full md:w-auto">
        ...
        <div class="flex flex-col text-white">
          <p class="text-xs md:text-sm lg:text-base font-normal mb-0.5 md:mb-1">
            Prefeitura Municipal de
          </p>

          <h1 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-0.5 md:mb-1">
            Software do Paraná
          </h1>

          <p class="text-xs md:text-sm lg:text-base font-normal italic">
      ...
      <div class="flex flex-col gap-3 w-full md:w-auto justify-center flex items-center">
        <div class="flex items-center gap-3 justify-center">
          ...
          <button type="button" class="xs:hidden inline-flex items-center justify-center p-2 w-10 h-10 
            text-white rounded-lg border focus:ring-2 focus:ring-white/60" @click="isSearchOpen = !isSearchOpen">
            <LupaIcon />
          </button>

          <button type="button" class="md:hidden inline-flex items-center p-2 w-10 h-10 justify-center 
            text-sm text-white rounded-lg border focus:ring-2 focus:ring-white/60" @click="toggleMenu">
            <MenuIcon />
          </button>
        </div>
